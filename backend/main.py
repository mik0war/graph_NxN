...
parameters_list = [
 #    Interval(0.1, 0.2, Parameters(750, 800, 960, 530)),
 #    Interval(0.2, 0.6, Parameters(750, 1000, 960, 530)),
 # #   Interval(0.5, 0.7, Parameters(750, 650, 960, 530)),
 #    Interval(0.6, 0.9, Parameters(750, 500, 960, 530)),
]
...
p_i = calculator.calculate(matrix_coefficients, 0.0, 0.1, 4000)
for interval in parameters_list:
    ...
    p_new = calculator.calculate(matrix, interval.time_start, interval.time_end, 4000, init_p)
...
# calculator.visualise(visualiser)
intervals = [Interval(0.0, 0.1, parameters)] + parameters_list
calculator.visualise_throughput(visualiser, intervals)
